...
export function GeneratePanel({ onSuccess, className = "" }: GeneratePanelProps) {
  const {
    prompt,
    setPrompt,
    model: selectedModel,
  ...
  }, [placeholderIndex, locale, placeholders]);
  ...
  return (
    <div className={`w-full rounded-[24px] bg-white/60 dark:bg-black/40 backdrop-blur-xl border border-gray-200 dark:border-white/10 p-2 shadow-2xl overflow-hidden ring-1 ring-gray-200 dark:ring-white/5 transition-colors duration-300 ${className}`}>
